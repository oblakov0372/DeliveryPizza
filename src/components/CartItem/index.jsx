...
import { plusCount, minusCount } from '../../redux/slices/cartSlice';

const CartItem = ({ id, title, price, imageUrl, types, sizes }) => {
  ...
  return (
    <div class="cart__item">
      ...
      <div class="cart__item-remove" >
        <div onClick={() => dispatch(removeItem(id))} class="button button--outline button--circle">
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
